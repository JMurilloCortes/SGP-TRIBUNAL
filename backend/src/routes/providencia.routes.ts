...
import { list, create, listPendientes, listHistorial, notificar, remove, cumplirTermino } from '../controllers/providencia.controller'
...
router.get('/providencias/historial', authorize('NOTIFICADOR', 'ADMIN'), listHistorial)
